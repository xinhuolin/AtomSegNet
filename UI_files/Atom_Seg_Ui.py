...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modelPath.setItemText(0, _translate("MainWindow", "circularMask"))
        self.modelPath.setItemText(1, _translate("MainWindow", "circularMask_mse_beta"))
        ...
        self.modelPath.setItemText(4, _translate("MainWindow", "guassianMask"))
        self.modelPath.setItemText(5, _translate("MainWindow", "gaussianMask+"))
        self.modelPath.setItemText(6, _translate("MainWindow", "denoise"))
        self.modelPath.setItemText(7, _translate("MainWindow", "denoise&bgremoval"))
        self.modelPath.setItemText(8, _translate("MainWindow", "denoise&bgremoval&superres"))
        self.modelPath.setItemText(9, _translate("MainWindow", "denoise&airysuperrez_beta"))
        self.modelPath.setItemText(10, _translate("MainWindow", "Gen1-noNoiseNoBackgroundSuperresolution"))
        self.modelPath.setItemText(11, _translate("MainWindow", "Gen1-circularMask"))
        self.modelPath.setItemText(12, _translate("MainWindow", "Gen1-gaussianMask"))
        self.modelPath.setItemText(13, _translate("MainWindow", "Gen1-noBackgroundNonoise"))
        self.modelPath.setItemText(14, _translate("MainWindow", "Gen1-noNoise"))
